...
5. The format of data that transmit through the network is string. All the results are combined as a single string with ¡°/¡° inserted between each result. After receiving the string, all devices get useful information by dividing the string into pieces according to the location of ¡°/¡°.

6. Through my tests, all files work will and can get right results as expected.

7. I use code from "Beej's Guide to Network Programming", the methods are:
